      ...
      <section className="py-5 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-lg mb-4 leading-relaxed">
            Welcome to MENSK Consultancy, an upcoming consultancy firm dedicated
            to providing comprehensive and innovative solutions to businesses
            and individuals navigating the intricate landscape of law and
            commerce in the United Arab Emirates (UAE). With a strong foothold
            in India and a reputation for excellence, we bring unparalleled
            expertise and insight.
          </p>
          <p className="text-lg leading-relaxed">
            At MENSK, we specialize in a diverse range of legal services
            tailored to meet the evolving needs of our clients. Whether you&apos;re a
            budding entrepreneur seeking startup advisory, a forward-thinking
            investor exploring opportunities in Digital Assets and Real Estate.
          </p>
        </div>
      </section>
