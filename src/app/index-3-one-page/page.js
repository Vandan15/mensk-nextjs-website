...
export const metadata = {
  title: "One Page Home Three - Oslim Business Consulting",
  description: "Modern one-page business consulting layout with comprehensive solutions, professional services, testimonials, and contact information in a seamless scrollable format.",
};
