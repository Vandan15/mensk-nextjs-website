...
export const metadata = {
  ...
  description: "Privacy Policy for MENSK Consultancy. Learn how we collect, use, and protect your personal information when you use our website and services.",
};
              ...
              <div className="privacy-content">
                ...
                <div className="privacy-section mb-5">
                  <p className="lead">
                    ...
                    <a href="https://www.menskconsultancy.com" target="_blank" rel="noopener noreferrer">
                      www.menskconsultancy.com
                    </a>{" "}
                    and covers information shared and collected on the website. This policy is not applicable to offline information collection.
                  </p>
                </div>
                ...
                <div className="privacy-section mb-5">
                  ...
                  <ul className="list-unstyled ps-4">
                    ...
                    <li className="mb-2">• Personalize your website experience</li>
                    ...
                    <li className="mb-2">• Communicate with you, either directly or through one of our partners</li>
                    <li className="mb-2">• Provide you with customer service and support</li>
                    <li className="mb-2">• Send you marketing and promotional communications</li>
                ...
                <div className="privacy-section mb-5">
                  ...
                  <p>
                    MENSK Consultancy follows a standard procedure of using log files. These files log visitors when they visit websites. The information collected by log files includes:
                  </p>
                  <ul className="list-unstyled ps-4">
                  ...
                  <p className="mt-3">
                    This information is not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.
                  </p>
                </div>
                ...
                <div className="privacy-section mb-5">
                  ...
                  <p>
                    Like any other website, MENSK Consultancy uses cookies. These cookies are used to:
                  </p>
                  <ul className="list-unstyled ps-4">
                    <li className="mb-2">• Store information about visitors' preferences</li>
                    <li className="mb-2">• Track which pages the visitor accessed or visited</li>
                    <li className="mb-2">• Customize web page content based on visitors' browser type or other information</li>
                  </ul>
                </div>
                ...
                <div className="privacy-section mb-5">
                  ...
                  <p>
                    MENSK Consultancy does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.
                  </p>
                </div>
